            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  height: MediaQuery.of(context).size.height * 0.75, // Ajustar la altura de la tipo carta
                      ...
                      Expanded(
                        child: StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            print("Notas recibidas: ${snapshot.data!.docs.length}");
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) => NotaDetalleScreen(
                                          noteName: noteName,
                                          noteDetails: note['details'] ?? 'No hay detalles disponibles',
                                        ),
                                      ),
                                    );
                                  },
                                    ...
                                    actions: <Widget>[
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          _timer.cancel(); // Cancelar el temporizador antes de salir
